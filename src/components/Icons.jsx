...
export function HeartCardIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function StarIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="#FBBC05" {...props}>
    ...
    <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <defs>
        <linearGradient id="goldGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="50%" stopColor="#E0C85A"/>
          <stop offset="100%" stopColor="#C9A227"/>
        </linearGradient>
      </defs>
      <circle cx="20" cy="20" r="18" stroke="url(#goldGrad)" strokeWidth="1.5" fill="none"/>
      {[0, 60, 120, 180, 240, 300].map(deg => (
        <path key={deg} d="M20 5 Q25 12 20 20 Q15 12 20 5Z" fill="url(#goldGrad)" opacity="0.7" transform={`rotate(${deg} 20 20)`}/>
      ))}
      <circle cx="20" cy="20" r="4" fill="url(#goldGrad)"/>
    </svg>
  );
}
